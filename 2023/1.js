...
input.split("\n").forEach(line => {
    ...
    line.split("").forEach(char => {
        spelledNumber += char;
        switch (true) {
            case spelledNumber.includes("one"):
                char = 1;
                break;
            
            case spelledNumber.includes("two"):
                char = 2;
                break;

            case spelledNumber.includes("three"):
                char = 3;
                break;

            case spelledNumber.includes("four"):
                char = 4;
                break;

            case spelledNumber.includes("five"):
                char = 5;
                break;

            case spelledNumber.includes("six"):
                char = 6;
                break;

            case spelledNumber.includes("seven"):
                char = 7;
                break;

            case spelledNumber.includes("eight"):
                char = 8;
                break;

            case spelledNumber.includes("nine"):
                char = 9;
                break;
        ...
        if (/^\d+$/.test(char)) {
            lastDigit = char;
            spelledNumber = spelledNumber[spelledNumber.length - 1];
            if (numberS.length == 0) {
                numberS += char;
            }
        }
